...
WebUI.setText(findTestObject('Use switch case/Page_Town Square - My Team Mattermost/textarea_new cmt la da'), var)

switch (var) {
    case 'new cmt la day':
        WebUI.setText(findTestObject('Use switch case/Page_Town Square - My Team Mattermost/textarea_oh i am sorr'), 'oh i am sorry')

        break
    default:
        WebUI.setText(findTestObject('Use switch case/Page_Town Square - My Team Mattermost/textarea_oh i am sorr'), 'it is falt')
