...
WebUI.click(findTestObject('Data Driven/search/Page_Town Square - team1612499 Mattermost/circle'))

WebUI.setText(findTestObject('Data Driven/search/Page_Town Square - team1612499 Mattermost/input_Town Square_searchBox'), 
    keyword)

WebUI.sendKeys(findTestObject('Data Driven/search/Page_Town Square - team1612499 Mattermost/input_Town Square_searchBox'), 
