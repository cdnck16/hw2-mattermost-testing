...
WebUI.click(findTestObject('Page_Town Square - team1612499 Mattermost/span_Edit'))

WebUI.setText(findTestObject('Page_Town Square - team1612499 Mattermost/input_Nickname_nickname'), nickname)

WebUI.click(findTestObject('Page_Town Square - team1612499 Mattermost/span_Save'))
