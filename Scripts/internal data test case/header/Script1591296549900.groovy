...
WebUI.click(findTestObject('Data Driven/header/Page_Town Square - team1612499 Mattermost/button_Set a Header'))

WebUI.setText(findTestObject('Data Driven/header/Page_Town Square - team1612499 Mattermost/textarea_tes'), header)

WebUI.click(findTestObject('Data Driven/header/Page_Town Square - team1612499 Mattermost/span_Save'))
